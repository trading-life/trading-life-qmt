...
def init(ContextInfo):
	print("hello")
	ws = wsc.WebSocketApp("ws://127.0.0.1:10008/ws/message", on_message=on_message, on_error=on_error,on_close=on_close,on_open=on_open,header={"CustomHeader1":"你好", "NewHeader2":"Test"})
	ws.run_forever()
	print("hwllo")
